---
name: unslop
description: "Cut AI tells from any writing: AI vocabulary, filler, hedging, em dashes, inline-header lists, chatbot phrases, mannered prose. Use when writing or editing any prose the user will read (docs, messages, PR descriptions, commit messages), or when another skill asks for it."
---
